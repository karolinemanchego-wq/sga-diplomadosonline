...
abstract class ProgramaAcademico {
    ...
    // EVAL-02: Criterio de Éxito - Polimorfismo puro original
...
class Curso extends ProgramaAcademico {
    ...
    public boolean evaluarAprobacion(List<Double> notas) {
        ...
        double suma = (notas == null) ? 0.0 : notas.stream().mapToDouble(Double::doubleValue).sum();
...
class Bootcamp extends ProgramaAcademico {
    ...
    @Override
    public boolean evaluarAprobacion(List<Double> notas) {
            boolean tieneFaltantes = (notas == null || notas.size() < 3);
        boolean aprobacionDirecta = !tieneFaltantes && notas.stream().allMatch(n -> n >= 14.0);
        return aprobacionDirecta;
    }
}
                ...
                case "true" -> {
                    ...
                    switch (String.valueOf(excedeLimite)) {
                        ...
                        case "false" -> {
                            ...
                            guardarEstudiantesTxt(); 
                            System.out.println("Notas actualizadas con éxito.");
                            return;
                        }
                    }
                }
    ...
    public void deshacerUltimaNota() {
        ...
        switch (String.valueOf(vacia)) {
            ...
            case "false" -> {
                ...
                guardarEstudiantesTxt();
                System.out.println("Deshecho: Se restauraron las notas anteriores de " + historial.alumno.getNombreCompleto() + ".");
            }
        }
    }
    ...
    public void generarColaCertificados() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("certificados_pendientes.txt"))) {
            ...
            for (Alumno est : colaCertificados) {
                ...
                double prom = suma / 3.0; // CORRECCIÓN: Promedio base 3 siempre
