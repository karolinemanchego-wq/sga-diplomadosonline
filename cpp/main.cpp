...
// 1. JERARQUÍA DE CLASES Y POLIMORFISMO
...
private:
    ...
    std::stack<RegistroHistorial> pilaHistorialNotas;
...
public:
    ...
    void registrarAlumno(Alumno* alumno) {
        ...
        std::cout << "Alumno " << alumno->getNombreCompleto() << " registrado con exito.\n";
    }

    void registrarProfesor(Profesor* profesor) {
        listaProfesores.push_back(profesor);
        guardarProfesoresTxt();
        std::cout << "Profesor " << profesor->getNombreCompleto() << " registrado con exito.\n";
    }
        ...
        for (Alumno* a : listaAlumnos) {
            ...
            switch (coincideCedula) {
                case true: {
                    ...
                    switch (excedeLimite) {
                        case true:
                            std::cout << "Error: No se pueden registrar mas de 3 notas para este programa.\n";
                            return;
                        case false:
                            ...
                            guardarEstudiantesTxt(); 
                            std::cout << "Notas actualizadas con exito para " << a->getNombreCompleto() << ".\n";
                            return;
                    }
                }
                default: break;
    ...
    void generarColaCertificados() {
        ...
        while (!tempCola.empty()) {
            ...
            double prom = suma / 3.0; // El promedio evalúa la base de 3 evaluaciones programadas
...
int main() {
    ...
    while (enEjecucion) {
        ...
        switch (opcionVacia) {
            case true:
                std::cout << "Error: Ingrese un valor numerico valido del 1 al 7.\n";
        ...
        switch (optChar) {
            ...
            case '1': {
                ...
                std::cout << "Cedula: "; std::getline(std::cin, ced);
            ...
            case '3': {
                ...
                std::cout << "Cedula del alumno: "; std::getline(std::cin, ced);
                std::cout << "Ingrese las notas separadas por comas (ej: 20,15,10): ";
                            ...
                            switch (errorRango) {
                                ...
                                case false:
                                    switch (listaDeNotas.empty()) {
                                        case true:  
                                            std::cout << "Error: No ingreso ninguna nota.\n"; 
                                            break;
                                        case false: 
